...
@section('title')
  <title> Hospital - {{$user->name}} </title>
@endsection
  ...
  <div class="public-jumptron col-xs-12">
        ...
        <div class="profile-box col-xs-12">
            <div class="container">
                <div class="profile-img col-md-3 col-xs-12">
                    <div class="img-outer">
                      <form enctype="multipart/form-data" files="true" action="/user/prof-img" method="post">
                        {{ csrf_field() }}
                        <a href="#" onclick="$('#my_file').click()"><img src="{{$user->prof_img}}" alt=""></a>
                ...
                <div class="profile-data col-md-9 col-xs-12">
                    <div class="data-left col-md-6 col-xs-12">
                        ...
                        <ul class="sec-list">
                            ...
                            <li>
                                <span>{{$user->Doctor->exp_years}}</span>
                            </li>
                            <li>
                                <span>{{$user->Doctor->office_address}}</span>
                            </li>
                            <li>
                                <span>{{$user->Doctor->work_days}}</span>
                            </li>
                          @endif
                            <li>
                ...
                @if($user->Doctor || $user->role == "receptionist")
